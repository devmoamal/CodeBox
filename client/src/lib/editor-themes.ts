...
export const getEditorTheme = (themeName: Theme) => {
  // Nord is dark despite having a blueish palette; only light themes are solarized-light and CodeBox-light
  ...
  > = {
    ...
    coffee: {
      ...
      text: "#E8D5B7",
      caret: "#C8873A",
      selection: "rgba(200, 135, 58, 0.2)",
    },
  };

  const themeColors = colors[themeName] || colors["CodeBox-dark"];
